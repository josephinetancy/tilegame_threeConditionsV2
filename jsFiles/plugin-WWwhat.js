var jsPsychWWHtmlKeyboardResponse = (function (jspsych) {
  ...
  const info = {
      ...
      parameters: {
          ...
          ending_time: {
              type: jspsych.ParameterType.INT,
              pretty_name: "Partner's official end time: probably 400ms",
              default: null,
          },
      ...
      trial(display_element, trial) {
          ...
          var after_response = (info) => {
              ...
              if (response.rt > trial.partner_rt) {
                console.log("responsert > trial partner_rt");
                response.delay = 0;
                  end_trial();
              } else {
              response.delay = trial.ending_time - response.rt; // Calculate delay
              console.log("trial.ending_time - response.rt, will be a delay");
              setTimeout(() => {
                end_trial();
              }, response.delay);
    }
