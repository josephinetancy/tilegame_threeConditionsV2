...
const taskConfigurations = {
    ...
    4: [p.findingPartner, p.partnerNext, p.task.round1Intro, p.task.SoloCircleLow, p.flowMeasure, p.intro.r2part1a, p.intro.r2part1, p.intro.r1soloHigh, p.intro.r1check, p.findingPartner, p.partnerNext, p.task.round2Intro, p.task.GroupSquareHigh, p.flowMeasure, p.demographics, p.save_data, p.end],
