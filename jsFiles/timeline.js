...
const taskConfigurations = {
    1: [p.findingPartner, p.partnerNext, p.task.round1Intro, p.task.SoloCircleHigh, p.flowMeasure, p.enjoymentMeasure, p.intro.r2part1a, p.intro.r2part1, p.intro.r1soloHigh, p.intro.r1check, p.intro.r2deduction, p.findingPartner, p.task.round2Intro, p.task.GroupSquareLow, p.flowMeasure, p.enjoymentMeasure, p.demographics, p.save_data, p.end],
    2: [p.findingPartner, p.partnerNext, p.task.round1Intro, p.task.GroupSquareLow, p.flowMeasure, p.enjoymentMeasure, p.intro.r2part1a, p.intro.r2part1, p.intro.r1soloHigh, p.intro.r1check, p.intro.r2deduction, p.findingPartner, p.task.round2Intro, p.task.SoloCircleHigh, p.flowMeasure, p.enjoymentMeasure, p.demographics, p.save_data, p.end],
    3: [p.findingPartner, p.partnerNext, p.task.round1Intro, p.task.SoloCircleLow, p.flowMeasure, p.enjoymentMeasure, p.intro.r2part1a, p.intro.r2part1, p.intro.r1soloHigh, p.intro.r1check, p.findingPartner, p.task.round2Intro, p.task.GroupSquareHigh, p.flowMeasure, p.enjoymentMeasure, p.demographics, p.save_data, p.end],
    4: [p.findingPartner, p.partnerNext, p.task.round1Intro, p.task.GroupSquareHigh, p.flowMeasure, p.enjoymentMeasure, p.intro.r2part1a, p.intro.r2part1, p.intro.r1soloHigh, p.intro.r1check, p.findingPartner, p.task.round2Intro, p.task.SoloCircleLow, p.flowMeasure, p.enjoymentMeasure, p.demographics, p.save_data, p.end],
    5: [p.findingPartner, p.partnerNext, p.task.round1Intro, p.task.SoloSquareHigh, p.flowMeasure, p.enjoymentMeasure, p.intro.r2part1a, p.intro.r2part1, p.intro.r1soloHigh, p.intro.r1check, p.findingPartner, p.task.round2Intro, p.task.GroupCircleLow, p.flowMeasure, p.enjoymentMeasure, p.demographics, p.save_data, p.end],
    6: [p.findingPartner, p.partnerNext, p.task.round1Intro, p.task.GroupCircleLow, p.flowMeasure, p.enjoymentMeasure, p.intro.r2part1a, p.intro.r2part1, p.intro.r1soloHigh, p.intro.r1check, p.findingPartner, p.task.round2Intro, p.task.SoloSquareHigh, p.flowMeasure, p.enjoymentMeasure, p.demographics, p.save_data, p.end],
    7: [p.findingPartner, p.partnerNext, p.task.round1Intro, p.task.SoloSquareLow, p.flowMeasure, p.enjoymentMeasure, p.intro.r2part1a, p.intro.r2part1, p.intro.r1soloHigh, p.intro.r1check, p.findingPartner, p.task.round2Intro, p.task.GroupCircleHigh, p.flowMeasure, p.enjoymentMeasure, p.demographics, p.save_data, p.end],
    8: [p.findingPartner, p.partnerNext, p.task.round1Intro, p.task.GroupCircleHigh, p.flowMeasure, p.enjoymentMeasure, p.intro.r2part1a, p.intro.r2part1, p.intro.r1soloHigh, p.intro.r1check, p.findingPartner, p.task.round2Intro, p.task.SoloSquareLow, p.flowMeasure, p.enjoymentMeasure,p.demographics, p.save_data, p.end],
}; 
