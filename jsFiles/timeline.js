...
const taskConfigurations = {
    1: [p.findingPartner, p.partnerNext, p.task.round1Intro, p.task.SoloCircleLow, p.flowMeasure, p.enjoymentMeasure, p.intro.r2part1a, p.intro.r2part1, p.intro.r1soloHigh, p.intro.r1check, p.findingPartner, p.task.round2Intro, p.task.GroupSquareHigh, p.flowMeasure, p.enjoymentMeasure, p.demographics, p.save_data, p.end],
    2: [p.findingPartner, p.partnerNext, p.task.round1Intro, p.task.GroupSquareLow, p.flowMeasure, p.enjoymentMeasure, p.intro.r2part1a, p.intro.r2part1, p.intro.r1soloHigh, p.intro.r1check, p.findingPartner, p.task.round2Intro, p.task.SoloCircleHigh, p.flowMeasure, p.enjoymentMeasure, p.demographics, p.save_data, p.end],
