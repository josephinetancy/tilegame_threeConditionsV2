...
const taskConfigurations = {
    ...
    8: [p.findingPartner, p.task.round1Intro, p.flowMeasure, p.intro.r2part1, p.intro.r2part2, p.intro.r1soloHigh, p.intro.r1check, p.task.round2Intro, p.flowMeasure, p.demographics, p.save_data, p.end],
}; 
