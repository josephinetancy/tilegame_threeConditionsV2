...
//        }
    ...
    var stim = {
        ...
        m3: `<div class="outer-circle" style="background-color: gray; 
        width: 150px; height: 150px; border-radius: 50%; 
        border: 5px solid black; display: flex; align-items:center; justify-content:center;">
        <div class="inner-circle" style="background-color:blue; border: 5px solid black;
            width: 100px; height: 100px; border-radius: 50%;"></div>
    ...
    */
    ...
    this.stimulus = `<div class="outer-circle" style="background-color: gray; 
        width: 150px; height: 150px; border-radius: 50%; 
        border: 5px solid black; display: flex; align-items:center; justify-content:center;">
    ...
    }; */ //SHOULD ASK IF I NEED TO DO THIS DISTRIBUTION OF NUMBERS
    ...
    function MakeOuter(round) {
        this.type = 'html-keyboard-response';
        this.data = {Trial_Type: 'Outer'};
        this.stimulus = '<div class="outer-circle" style="background-color:gray; width: 150px; height: 150px; border-radius: 50%;"></div>';// for at the start
        this.trial_duration = function(){ 
         //   return latency[round][trialNumber] 
            [1000]
        };
    ...
    // Combine the two into a parallel trial using a timeline
    const combinedTrial = {
    ...
    stimulus: function() {
        ...
        const outerHTML = `
         <div class="outer-circle" style="background-color:gray; width: 150px; height: 150px; 
                border-radius: 50%; position: relative; display: flex; align-items: center; justify-content: center;">`;
        
        // Display both on the same page
        return `
                ${outerHTML}
                ${probeHTML}
            </div>`;
...
//        [5000]
        // Decide how you want to determine the combined duration, 
        // for example, the longest duration between the two:
        //return Math.max(latency[round][trialNumber], latency[round][trialNumber]); 
    ...
    function MakeResponse(round) {
        ...
        this.choices = [32]; // represnts spacebar 
        this.response_ends_trial = false;
        this.trial_duration = 1000; //feedback for if you "get it or not"
